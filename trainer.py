...
class Trainer:
    def __init__(self, options):
        ...
        self.loss_writer=SummaryWriter("C:/Users/Administrator/Desktop/loss/scalenorm2norm2")
        ...
        if self.num_pose_frames == 2:
            ...
            for f_i in self.opt.frame_ids[1:]:
                if f_i != "s":
                    ...
                    outputs[("inv_cam_T_cam", f_i, 0)] = transformation_from_parameters(
                        axisangle[:, 0], translation[:, 0], invert=(f_i > 0))
        ...
        for scale in self.opt.scales:
            ...
            for i, frame_id in enumerate(self.opt.frame_ids[1:]):
                ...
                # if frame_id != 's':
                    ...
                    transformed_source_3d=Coord_3d_trans(source_cam_points,outputs[('inv_cam_T_cam', frame_id,0)])
    ...
    def compute_3d_loss(self, target, pre, next, pre_mask, next_mask):
        ...
        """
        l1 loss and norm 1 achieves similar results
        """
        ...
        # pre_loss=torch.norm(target[mask]-pre[mask],2)
        # next_loss=torch.norm(target[mask]-next[mask],2)
    ...
    def compute_losses(self, inputs, outputs):
        ...
        for scale in self.opt.scales:
            ...
            if scale==0:
                ...
                target_3d = self.backproject_depth[0](target_depth, inputs[("inv_K", 0)])[:,:3,:].view(target_depth.shape[0],3,self.opt.height,self.opt.width)
                ...
                loss_3d = self.compute_3d_loss(target_3d, pre_3d, next_3d, pre_mask, next_mask)*0.005
                print(loss_3d)
